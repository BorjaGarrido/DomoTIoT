...
urlpatterns = [
    ...
    url(r'^web/dht/(?P<dht_id>\d+)/delete/$', views.dht_delete, name='dht_delete'),
    url(r'^web/mq2/(?P<mq2_id>\d+)/delete/$', views.mq2_delete, name='mq2_delete'),
    url(r'^web/rfid/(?P<rfid_id>\d+)/delete/$', views.rfid_delete, name='rfid_delete'),
